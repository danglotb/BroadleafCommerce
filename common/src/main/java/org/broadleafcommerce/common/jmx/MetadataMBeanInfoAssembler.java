...
public class MetadataMBeanInfoAssembler extends org.springframework.jmx.export.assembler.MetadataMBeanInfoAssembler {
    ...
    protected javax.management.modelmbean.ModelMBeanAttributeInfo[] getAttributeInfo(java.lang.Object managedBean, java.lang.String beanKey) throws javax.management.JMException {
        managedBean = org.broadleafcommerce.common.jmx.AspectUtil.exposeRootBean(managedBean);
