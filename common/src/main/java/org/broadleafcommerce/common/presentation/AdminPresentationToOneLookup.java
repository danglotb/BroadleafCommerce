...
public @interface AdminPresentationToOneLookup {
    java.lang.String lookupDisplayProperty() default "";

    java.lang.String[] customCriteria() default {  };

    boolean useServerSideInspectionCache() default true;

    org.broadleafcommerce.common.presentation.client.LookupType lookupType() default org.broadleafcommerce.common.presentation.client.LookupType.STANDARD;
