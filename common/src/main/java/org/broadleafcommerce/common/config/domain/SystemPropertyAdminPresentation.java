...
@org.broadleafcommerce.common.presentation.AdminPresentationClass(friendlyName = "SystemPropertyImpl", tabs = { @org.broadleafcommerce.common.presentation.AdminTabPresentation(groups = { @org.broadleafcommerce.common.presentation.AdminGroupPresentation(name = org.broadleafcommerce.common.config.domain.SystemPropertyAdminPresentation.GroupName.General, order = org.broadleafcommerce.common.config.domain.SystemPropertyAdminPresentation.GroupOrder.General, untitled = true), @org.broadleafcommerce.common.presentation.AdminGroupPresentation(name = org.broadleafcommerce.common.config.domain.SystemPropertyAdminPresentation.GroupName.Placement, order = org.broadleafcommerce.common.config.domain.SystemPropertyAdminPresentation.GroupOrder.Placement, column = 1) }) })
public interface SystemPropertyAdminPresentation {
    ...
    public static class GroupName {
        ...
        public static final java.lang.String Placement = "SystemPropertyImpl_placement";
    }
